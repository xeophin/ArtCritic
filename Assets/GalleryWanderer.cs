...
public class GalleryWanderer : MonoBehaviour
{
  ...
  public float minObserveTime = 4;
  public float maxObserveTime = 9;
  ...
  {
    if (!floor.GetComponent<FloorArea> ().OnFloor (gx, gy, GetComponent<OnGrid> ().gridSize)) {
      return false;
    }
